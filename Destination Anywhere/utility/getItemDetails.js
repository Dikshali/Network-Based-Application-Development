...
var it1 = new itemModel(1001, 'Sachsenhausen Memorial Tour', 'Sachsenhausen Memorial Tour', 'Germany', {
...
var it2 = new itemModel(1002, 'Hitler\'s Germany: Berlin during the Third Reich & WWII Walking Tour', 'Hitler\'s Germany', 'Germany', {
...
var it3 = new itemModel(1003, 'East Berlin: City of Shadow', 'East Berlin', 'Germany', {
...
var it4 = new itemModel(2001, 'Burj Khalifa - At the Top Observation Deck', 'Burj Khalifa', 'Dubai', {
...
var it5 = new itemModel(2002, 'Desert Safari at Al Maha Experience with BBQ Dinner', 'Desert Safari', 'Dubai', {
...
var it6 = new itemModel(2003, 'Abu Dhabi Sheikh Zayed Mosque', 'Abu Dhabi', 'Dubai', {
...
var it7 = new itemModel(3001, 'Eiffel Tower Tour', 'Eiffel Tower Tour', 'France', {
...
var it8 = new itemModel(3002, 'Louvre Museum', 'Louvre Museum', 'France', {
...
var it9 = new itemModel(3003, 'River Seine Sightseeing Cruise', 'River Seine Sightseeing Cruise', 'France', {
...
var it10 = new itemModel(4001, 'Batu Caves', 'Batu Caves', 'Malaysia', {
...
var it11 = new itemModel(4002, 'Aquaria KLCC', 'Aquaria KLCC', 'Malaysia', {
...
var it12 = new itemModel(4003, 'Kuala Lampur City Tour', 'Kuala Lampur City Tour', 'Malaysia', {
...
item_list.push(category1);
item_list.push(category2);
item_list.push(category3);
item_list.push(category4);
...
var getItem = function(itemCode) {
  for (var i = 0; i < item_list.length; i++) {
    for (var j = 0; j < item_list[i].items.length; j++) {
      if (item_list[i].items[j].itemCode == itemCode) {
        return item_list[i].items[j];
      }
    }
  }
};
